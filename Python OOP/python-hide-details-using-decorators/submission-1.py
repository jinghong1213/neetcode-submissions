class SuperHero:
    ...
    @health.setter
    def health(self, input_health) -> None:
        if (input_health > 0):
    ...
    @power_level.setter
    def power_level(self, input_power_level) -> None:
        if (input_power_level > 10):
            print("You can't set the power level to more than 10")
        elif(input_power_level < 1):
            print("You can't set the power level to less than 1")
        else:
            self.__power_level = input_power_level
